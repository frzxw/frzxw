...
<div align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,rust,python,php,nextjs,react,astro,vite,npm,tailwind,nodejs,deno,nestjs,express,laravel,django,flask,fastapi,flutter,dart,kotlin,postgres,mysql,mongo,redis,supabase,prisma,docker,kubernetes,netlify,vercel,terraform,aws,gcp,git,github,vscode
&perline=10" />
</div>
